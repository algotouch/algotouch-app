...
export const registerUser = async ({ 
  ...
  try {
   ...
   email:        contractDetails.email        ?? registrationData.email        ?? null,
    phone:        contractDetails.phone        ?? registrationData.userData.phone ?? null,
    address:      contractDetails.address      ?? null,
    id_number:    contractDetails.idNumber     ?? null,
